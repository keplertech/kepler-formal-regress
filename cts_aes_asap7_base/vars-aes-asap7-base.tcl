...
set env(SDC_FILE) "$::env(FLOW_HOME)/designs/asap7/aes/constraint.sdc"
...
set env(VERILOG_FILES) "$::env(FLOW_HOME)/designs/src/aes/aes_cipher_top.v $::env(FLOW_HOME)/designs/src/aes/aes_inv_cipher_top.v $::env(FLOW_HOME)/designs/src/aes/aes_inv_sbox.v $::env(FLOW_HOME)/designs/src/aes/aes_key_expand_128.v $::env(FLOW_HOME)/designs/src/aes/aes_rcon.v $::env(FLOW_HOME)/designs/src/aes/aes_sbox.v $::env(FLOW_HOME)/designs/src/aes/timescale.v"
